...
- **Retention** penalises selling: sell up to 30% of your gold in a year and nothing happens; beyond that, $\text{Retention} = 1 - \frac{\text{sold} - 0.30}{0.70}$. Moving tokens to your own wallet is not selling and is not penalised.
